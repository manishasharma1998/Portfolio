          ...
          <div className="mx-auto grid w-full max-w-4xl grid-cols-2 gap-3 sm:flex sm:flex-row">
            {links.map((l) => (
              <a
                ...
                className="group flex min-w-0 flex-1 items-center justify-between gap-2 rounded-2xl border border-line bg-ink-850 px-3 py-3.5 transition-colors duration-300 hover:border-lens-400/40 sm:px-4 sm:py-4"
              >
