...
export function XRPlayground({ copy }: { copy: SiteConfig["xr"] }) {
  ...
  return (
    <section
      id="xr"
      className="relative overflow-hidden border-y border-white/[0.06] bg-[#07080c]"
    >
      <div className="mx-auto max-w-6xl px-5 py-24 sm:px-8 sm:py-32">
        ...
        <Reveal delay={0.12} className="mt-6">
          <div className="grid gap-4 md:grid-cols-3">
            <figure className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-ink-850">
