  ...
  return (
    <section id="about" className="mx-auto max-w-6xl px-5 py-24 sm:px-8 sm:py-32">
      ...
      <div className="mt-12 grid gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <Reveal delay={0.15}>
          <div className="grid gap-4">
            <div className="rounded-2xl border border-line bg-ink-850 p-6 sm:p-7">
      ...
      <Reveal delay={0.1} className="mt-12">
        <div className="rounded-2xl border border-line bg-gradient-to-br from-ink-850 via-ink-900 to-ink-850 p-6 sm:p-8">
          <p className="font-mono text-[11px] tracking-[0.25em] text-fog-500 uppercase">
            {about.pivotLabel}
          </p>
      ...
      <div className="mt-12 grid gap-4 sm:grid-cols-3">
        {photos.map((p, i) => (
          <Reveal key={p.src} delay={i * 0.08} className="h-full">
            <figure className="group flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-ink-850">
